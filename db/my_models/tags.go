...
func (r *tagR) GetMemberTags() MemberTagSlice {
	if r == nil {
		return nil
	}
	return r.MemberTags
...
var (
	tagAllColumns            = []string{"tag_id", "tag_name"}
	tagColumnsWithoutDefault = []string{"tag_name"}
...
func (o *Tag) MemberTags(mods ...qm.QueryMod) memberTagQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"member_tags\".\"tag_id\"=?", o.TagID),
	)
...
func (tagL) LoadMemberTags(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTag interface{}, mods queries.Applicator) error {
	var slice []*Tag
	var object *Tag
	...
	query := NewQuery(
		qm.From(`member_tags`),
		qm.WhereIn(`member_tags.tag_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Tag) AddMemberTags(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*MemberTag) error {
	...
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.TagID, rel.MemberTagID}
...
func FindTag(ctx context.Context, exec boil.ContextExecutor, tagID int, selectCols ...string) (*Tag, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"tags\" where \"tag_id\"=$1", sel,
	)
...
func (o *Tag) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"tags\" WHERE \"tag_id\"=$1"
...
func TagExists(ctx context.Context, exec boil.ContextExecutor, tagID int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"tags\" where \"tag_id\"=$1 limit 1)"
